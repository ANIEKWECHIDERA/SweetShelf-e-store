...
import { Badge, Button, Card, CardContent, CardDescription, CardHeader, CardTitle } from "@sweetshelf/shared-ui";
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
        ...
        <Card className="overflow-hidden bg-white/94">
          ...
          <CardContent className="flex flex-col gap-5">
            <p className="text-2xl font-semibold text-[var(--color-caramel-500)]">{formatCurrency(product.price)}</p>
            ...
            <div className="rounded-[24px] bg-[var(--color-caramel-50)] p-4">
              <p className="text-sm text-[var(--color-brown-800)]">
                Want a custom version, event-size cake, or message topper? We keep WhatsApp open for that final
                handoff.
              </p>
            </div>
            <a
